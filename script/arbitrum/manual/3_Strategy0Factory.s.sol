...
import {Strategy0Arbitrum, IToken, IStrategy} from "src/arbitrum/strategy0/Strategy0Arbitrum.sol";
import {Strategy0FactoryArbitrum} from "src/arbitrum/strategy0/Strategy0FactoryArbitrum.sol";
...
contract Strategy0FactoryScript is Script {
    ...
    function run() public {
        ...
        factory0 = new Strategy0FactoryArbitrum(address(poolsNFT));
