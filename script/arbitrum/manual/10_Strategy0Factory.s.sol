...
// Test purposes:
// $ forge script script/arbitrum/manual/10_Strategy0Factory.s.sol:Strategy0FactoryScript

// Mainnet deploy command:
// $ forge script script/arbitrum/manual/10_Strategy0Factory.s.sol:Strategy0FactoryScript --slow --broadcast --verify --verifier-url "https://api.arbiscan.io/api" --etherscan-api-key $ARBITRUMSCAN_API_KEY
...
contract Strategy0FactoryScript is Script {
    ...
    Strategy0Arbitrum public strategy0 = Strategy0Arbitrum(payable(address(0))); // address can be change
